        ...
        <div className="group rounded-2xl bg-neutral-900 border border-white/10 overflow-hidden flex flex-col h-full  transition-colors duration-300 hover:border-blue-500/30">
          ...
          <div className="p-6 flex flex-col grow">
            ...
            <p className="text-gray-400 text-sm mb-4 grow line-clamp-3">
              My friend and I created a website that can display Geographic
              Information System.
            </p>
      ...
      <div className="transition-all duration-1000 ease-out transform opacity-100 translate-y-0 ">
        <div className="group rounded-2xl bg-neutral-900 border border-white/10 overflow-hidden flex flex-col h-full  transition-colors duration-300 hover:border-blue-500/30">
          ...
          <div className="p-6 flex flex-col grow">
            ...
            {/* Code Github & Live Demo */}
            <div className="flex items-center gap-4 mt-auto">
              <button className="w-full py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-purple-500/20 hover:border-purple-500/30 hover:text-purple-300 text-gray-300 flex items-center justify-center gap-2 transition-all duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
