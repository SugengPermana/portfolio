...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      // edit border and bg
      className="group relative flex max-w-fit items-center justify-center gap-3 rounded-full border border-neutral-300 bg-white px-6 py-3 text-neutral-700 transition-colors dark:border-neutral-700/80 dark:bg-black dark:text-zinc-300"
    >
      {/* edit garis */}
      <div className="pointer-events-none absolute inset-x-0 bottom-full h-30 w-[150px]">
        <svg
