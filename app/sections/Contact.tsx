    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 relative z-10">
        <div data-aos="fade-up"
              data-aos-duration="1000" data-aos-delay="100" className="text-center flex flex-col items-center justify-center mb-20" >
        ...
        <div className="transition-all duration-1000 ease-out transform opacity-100 translate-y-0 ">
          <div className="flex flex-col gap-10">
            ...
            <div className="max-w-3xl mt-4">
              <h2 data-aos="fade-in"
              data-aos-duration="1000" data-aos-delay="300" className="text-2xl md:text-3xl font-medium text-foreground leading-tight">
